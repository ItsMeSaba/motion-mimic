...
export default function AnimationSidebar() {
  ...
  return (
    <aside className="w-80 relative overflow-hidden">
      <div className="bg-gray-900 border-r border-gray-800 py-6 px-5 pb-1 w-80 h-screen fixed grid grid-rows-[auto_1fr]">
        <div>
        ...
        <div className="space-y-2 overflow-y-auto h-full pr-2 [&::-webkit-scrollbar]:w-[3px] [&::-webkit-scrollbar-thumb]:bg-gray-600">
          {filteredAnimations.map((animation) => (
            <button
              ...
              className={`w-full flex items-center justify-between rounded-lg mb-5 p-2 transition-all duration-200 text-left group ${
